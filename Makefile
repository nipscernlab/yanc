...
# --- asmcomp (flex) ---------------------------------------------------------
$(BIN)/asmcomp$(EXE): $(addprefix $(ASM)/,$(ASMCOMP_C)) $(ASM)/ASMComp.l $(COMMON)/yanc_num.c $(COMMON)/yanc_num.h \
                      $(wildcard Compilers/ASMComp/Headers/*.h) $(VERSION_H) | $(BIN)
	cd $(ASM) && $(FLEX) -o ASMComp.c ASMComp.l
	$(CC) $(CFLAGS) -o $@ $(ASM)/ASMComp.c $(addprefix $(ASM)/,$(ASMCOMP_C)) $(COMMON)/yanc_num.c $(LDLIBS)
